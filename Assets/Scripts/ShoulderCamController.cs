...
public class ShoulderCamController : MonoBehaviour
{
   [Header("Movement")] 
    ...
    [SerializeField] float rotationSmoothFactor = 3;
    ...
    private void Awake()
    {
        ...
        anim = GetComponentInChildren<Animator>(); // el animator esta en uno de los hijos
    ...
    private void MoveAndRotate()
    {
        ...
        //Calcula la velocidad objetivo respetando joystick y teclado
        ...
        //Suavizar inputs para las animaciones
    ...
    private void OnTriggerEnter(Collider other)
    {
        if (other.gameObject.CompareTag("Respawn"))
        {
            ...
            menuManager.SetCursor(true);
        }
        if (other.gameObject.CompareTag("Lions"))
        {
            menuManager.AddLions();
